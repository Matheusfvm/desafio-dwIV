...
CREATE TABLE `usuarios` (
  ...
  `assunto_usuario` varchar(100) DEFAULT NULL,
  `descricao_usuario` varchar(250) DEFAULT NULL,
...
INSERT INTO `usuarios` VALUES (1,'matheus','ab','abc');
...
-- Dump completed on 2022-11-28 17:54:24
